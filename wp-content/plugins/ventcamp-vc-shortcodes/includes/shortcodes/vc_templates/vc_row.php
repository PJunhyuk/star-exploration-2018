...
$css = $bg_image = $bg_color = $vsc_bg_gradient = $video_attr = $vsc_custom_style = '';
...
if ( !empty( $vsc_youtube_url ) && class_exists( 'Video_Background' ) ) {
	...
	// Play video in loop?
	$video_loop = in_array( 'loop', $video_options ) ? true : false;
	...
	$video_settings = array(
		...
		"loop"        => $video_loop            // Play video in loop?
	);
...
// Row class
//----------------------------------------------------------
$el_class = $this->getExtraClass($vsc_class);
