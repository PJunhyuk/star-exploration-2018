                ...
                <tr>
                    ...
                    <td style="background-color:#ffffff">
                        <table width="260" border="0" cellspacing="20" cellpadding="0" align="left" style="background-color:#ffffff;border-collapse:separate" class="contenttable">
                            ...
                            <tr>
                                    <td align="center" style="width:220px;" width="220"><img style="display:block;" src="<?php echo $barcodeURL; ?><?php echo $ticket['WooCommerceEventsTicketID']; ?>.png"  style="width:220px;" width="220"/></td>
                            </tr>
                            <?php endif; ?>
                        </table>
